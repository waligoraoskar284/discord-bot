 ...
 *   Przy tworzeniu ticketa ta rola NIE ma dostępu (deny ViewChannel). Po zamknięciu
 *   ticketu otrzymuje dostęp do przeglądania (ViewChannel: true, SendMessages: false).
 *   Po ponownym otwarciu przywracany jest stan: role MOD nie widzi otwartego ticketa.
 * - Naprawa "trzeba klikać dwa razy": wszystkie przyciski deferrują odpowiedź natychmiast
 *   (interaction.deferReply) i potem używamy interaction.editReply, co zapobiega timeoutom
 *   i "zawieszaniu" interakcji.
 *
 * Inne przypomnienia:
 * - Dostosuj ID (TICKET_CHANNEL_ID, ADMIN_ROLE_ID, MOD_BUTTONS_ROLE_ID, TICKETS_CATEGORY_ID, CLOSED_CATEGORY_ID, LOG_CHANNEL_ID).
...
module.exports = (client) => {
  ...
  const LOG_CHANNEL_ID = '1454069542283120642'; // <-- Zmienione na wskazany kanał
