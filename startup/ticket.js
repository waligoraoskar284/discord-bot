...
module.exports = (client) => {
  ...
  client.on(Events.InteractionCreate, async (interaction) => {
    ...
    // (kod dla admin_moderation, admin_roles, admin_ticketmanage, admin_* actions dalej jak wcześniej)
    // Dla skrótu nie powtarzam ich tu, ale w Twoim pliku pozostają niezmienione.
