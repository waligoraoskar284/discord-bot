  ...
  client.on(Events.InteractionCreate, async (interaction) => {
    ...
    try {
      ...
      if (!token || token !== lastSetup.token) {
        // Usuń starą ograniczoną wiadomość (aby nie generowała systemowego angielskiego komunikatu przy kliknięciu)
        ...
        // Odpowiedz użytkownikowi po polsku, że stara wiadomość była nieaktualna
