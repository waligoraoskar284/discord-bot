...
module.exports = (client) => {
  ...
  client.on(Events.InteractionCreate, async (interaction) => {
    ...
    // ... (reszta kodu bez zmian - obsługa admin paneli, warn, giverole, itp.)
    // Ze względu na długość pominięto powtórzenie całego kodu — reszta zachowuje się tak jak wcześniej.
