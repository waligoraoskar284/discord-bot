...
// ID Twoich emoji
const EMOJI_WITAJ = '1452715257586913373';
const EMOJI_REGULAMIN = '1452715580456042647';
const EMOJI_KONKURS = '1452715878205624391';
    ...
    client.on(Events.GuildMemberAdd, async (member) => {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(
                    `> <:${EMOJI_WITAJ}> Witaj <@${member.id}> na serwerze **Sprawdziany & Kartkówki**!\n` +
                    `> <:${EMOJI_REGULAMIN}> Regulamin: <#${RULES_CHANNEL_ID}>\n` +
                    `> <:${EMOJI_KONKURS}> Konkursy: <#${CONTEST_CHANNEL_ID}>`
                )
