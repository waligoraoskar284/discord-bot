    ...
    client.on(Events.GuildMemberAdd, async (member) => {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: 'Sprawdziany & Kartkówki Powitalnia', value: `${userPing}` })
                .setThumbnail(member.user.displayAvatarURL({ dynamic: true }))
                .setFooter({ text: `© 2025r. Sprawdziany & Kartkówki × Powitalnia•${formattedDate}` });
