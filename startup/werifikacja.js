...
module.exports = (client) => {
    client.once(Events.ClientReady, async () => {
        ...
        const verifySent = process.env.VERIFY_SENT === 'true';
        if (verifySent) return; // jeśli już wysłano, nic nie robimy
        ...
        try {
            ...
            // Tworzymy embed z dużym obrazkiem
            ...
            // **WAŻNE**: Teraz w panelu Render musisz ustawić zmienną środowiskową
            // VERIFY_SENT = true, aby bot nie wysłał ponownie przy restarcie
